    ...
    ?>
                    <div class="url-card col-6 col-sm-6 col-md-4 col-xl-5a col-xxl-6a">
                        <div class="url-body default">
                            <a href="<?php echo $link['url']; ?>" target="_blank" data-url="<?php echo $link['url']; ?>" class="card no-c mb-4" data-toggle="tooltip" data-placement="bottom" data-original-title="<?php echo $link['description']; ?>">
                                <div class="card-body">
...
?>
                <div class="d-flex flex-fill">
                    <h4 class="text-gray text-lg mb-4">
<?php if(empty($category['icon'])){ ?>
                        <i class="<?php echo $category['font_icon']; ?> icon-fw mr-2" id="category-<?php echo $category['id']; ?>"></i>
<?php }else{ ?>
                        <img class="icon" src="<?php echo get_category_icon($category['icon']); ?>">
<?php } ?>
